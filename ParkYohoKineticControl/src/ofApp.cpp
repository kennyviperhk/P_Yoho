...
void ofApp::guiSetup(){
    ...
    cableSpeedX.set("S2 X ",800,0,MAX_X_SPEED);
    cableAccelX.set("A2 X " ,300,0,MAX_X_ACCEL);
    
    cableSpeedY.set("S2 Y ",800,0,MAX_Y_SPEED);
    cableAccelY.set("A2 Y ",300,0,MAX_Y_ACCEL);
