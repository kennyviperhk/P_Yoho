/*  
Based on v4_Arduino_Servo_Controller
  ...
  -Adding time controlled movement
  -Adding test specific Motor
...
long stepperTime[numOfStepper]  = {0, 0, 0, 0};  // Travel Time to POS
...
MyStepper stepperRx (AccelStepper::DRIVER, rxStep, rxDir);
MyStepper stepperRy (AccelStepper::DRIVER, ryStep, ryDir);

MyStepper* steppers[numOfStepper] = { &stepperLx, &stepperLy, &stepperRx, &stepperRy};
...
long prevStepperMillis[numOfStepper] = {0, 0, 0, 0};
