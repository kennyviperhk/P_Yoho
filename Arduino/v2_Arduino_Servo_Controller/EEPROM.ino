...
void Load_Flash()
{
  ...
  //RUNNING
  MAX_SPEED_X =  EEPROMReadInt(2);
  MAX_ACCELERATION_X  =  EEPROMReadInt(3);
  MAX_SPEED_Y =  EEPROMReadInt(4);
  MAX_ACCELERATION_Y  =  EEPROMReadInt(5);
  MAX_POSITION_LX =  EEPROMReadInt(6);
  MAX_POSITION_LY =  EEPROMReadInt(7);
  MAX_POSITION_RX =  EEPROMReadInt(8);
  MAX_POSITION_RY =  EEPROMReadInt(9);
  INVERT_DIR_LX =  EEPROMReadInt(10);
  INVERT_DIR_LY =  EEPROMReadInt(11);
  INVERT_DIR_RX =  EEPROMReadInt(12);
  INVERT_DIR_RY =  EEPROMReadInt(13);
...
void Write_Flash()
{
  ...
  EEPROMWriteInt(1, HOME_ACCELERATION); //
  //RUNNING
  EEPROMWriteInt(2, MAX_SPEED_X); //
  EEPROMWriteInt(3, MAX_ACCELERATION_X ); //
  EEPROMWriteInt(4, MAX_SPEED_Y); //
  EEPROMWriteInt(5, MAX_ACCELERATION_Y ); //
  EEPROMWriteInt(6, MAX_POSITION_LX); //
  EEPROMWriteInt(7, MAX_POSITION_LY); //
  EEPROMWriteInt(8, MAX_POSITION_RX); //
  EEPROMWriteInt(9, MAX_POSITION_RY); //
  EEPROMWriteInt(10, INVERT_DIR_LX); //
  EEPROMWriteInt(11, INVERT_DIR_LY); //
  EEPROMWriteInt(12, INVERT_DIR_RX); //
  EEPROMWriteInt(13, INVERT_DIR_RY); //
